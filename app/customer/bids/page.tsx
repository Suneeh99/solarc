        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage your bid sessions and view installer proposals
            </p>
          </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  When you open a bid, installers have 48 hours to submit
                  proposals. Accept a bid to move the linked application into
                  installation, or let it expire to choose packages directly.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-foreground">
              Bid Sessions ({enrichedSessions.length})
            </CardTitle>
            <CardDescription>
              View and manage your active and past bid sessions
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
