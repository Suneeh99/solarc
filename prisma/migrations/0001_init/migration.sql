...
-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('pending', 'under_review', 'site_visit_scheduled', 'approved', 'rejected', 'payment_pending', 'payment_confirmed', 'finding_installer', 'installation_in_progress', 'installation_complete', 'final_inspection', 'agreement_pending', 'completed');
